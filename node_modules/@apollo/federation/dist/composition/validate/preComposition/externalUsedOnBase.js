                ...
                for (const field of typeDefinition.fields) {
                    if (field.directives) {
                        for (const directive of field.directives) {
                            ...
                            if (name === 'external') {
                                errors.push((0, utils_1.errorWithCode)('EXTERNAL_USED_ON_BASE', (0, utils_1.logServiceAndType)(serviceName, typeDefinition.name.value, field.name.value) +
                                    `Found extraneous @external directive. @external cannot be used on base types.`, (0, utils_1.findDirectivesOnNode)(field, 'external')));
                            }
                        }
                    }
                }
