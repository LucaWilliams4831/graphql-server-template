        ...
        for (const [fieldName, field] of Object.entries(namedType.getFields())) {
            ...
            if (fieldFederationMetadata === null || fieldFederationMetadata === void 0 ? void 0 : fieldFederationMetadata.requires) {
                ...
                for (const selection of selections) {
                    ...
                    const typeFederationMetadata = (0, utils_1.getFederationMetadata)(matchingFieldOnType);
                    if (typeFederationMetadata === null || typeFederationMetadata === void 0 ? void 0 : typeFederationMetadata.serviceName) {
                        ...
                        const selectionSetNode = (0, utils_1.findSelectionSetOnNode)(fieldNode, 'requires', (0, utils_1.printFieldSet)(selections));
                        errors.push((0, utils_1.errorWithCode)('REQUIRES_FIELDS_MISSING_ON_BASE', (0, utils_1.logServiceAndType)(serviceName, typeName, fieldName) +
