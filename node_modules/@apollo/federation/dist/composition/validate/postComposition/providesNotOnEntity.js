...
const providesNotOnEntity = ({ schema, serviceList }) => {
    ...
    for (const [typeName, namedType] of Object.entries(types)) {
        ...
        for (const [fieldName, field] of Object.entries(namedType.getFields())) {
            const fieldFederationMetadata = (0, utils_1.getFederationMetadata)(field);
            ...
            if (!serviceName)
                continue;
            const getBaseType = (type) => (0, graphql_1.isListType)(type) || (0, graphql_1.isNonNullType)(type)
            ...
            if (fieldFederationMetadata === null || fieldFederationMetadata === void 0 ? void 0 : fieldFederationMetadata.provides) {
                ...
                const providesDirectiveNode = (0, utils_1.findDirectivesOnNode)(fieldNode, 'provides');
                if (!(0, graphql_1.isObjectType)(baseType)) {
                    errors.push((0, utils_1.errorWithCode)('PROVIDES_NOT_ON_ENTITY', (0, utils_1.logServiceAndType)(serviceName, typeName, fieldName) +
                ...
                const selectedFieldIsEntity = (_b = (0, utils_1.getFederationMetadata)(fieldType)) === null || _b === void 0 ? void 0 : _b.keys;
